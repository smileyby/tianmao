...
function aa(i)
{
  var father=$(".centerbox")[i];
  var t=setInterval(moveleft,2000);
          function moveleft()
        {
             var first=getFirst(father);
             animate(father,{left:-112},600,Tween.Linear,function()
              {
        ...
        function moveright()
        {
             ...
             var first=getFirst(father);
             father.style.left=-112+"px";
             father.insertBefore(last,first);
             animate(father,{left:112},600,Tween.Linear);
             animate(father,{left:0},600,Tween.Linear);
         }
         var left=$(".center-left")[i];
       var right=$(".center-right")[i];
